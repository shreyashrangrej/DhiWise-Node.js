...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Margarette.Haag',
      password: 'Vlvt1PiM3vd9W4s',
      email: 'Erling.Heller27@yahoo.com',
      name: 'Edmond Fadel',
      userType: 983,
      mobileNo: '(468) 459-9135',
      resetPasswordLink: {},
      loginRetryLimit: 159,
      loginReactiveTime: '2023-10-15T22:32:07.961Z',
      id: '636dd4c589d75ec8430f5809'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Ila_West',
        'password':'M9aP_HRsbmK0ukP',
        'email':'Antone60@gmail.com',
        'name':'Mr. Joel Lakin',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(182) 049-0179',
