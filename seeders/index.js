...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'0TXSvDbMHWUP1sm',
      'isDeleted':false,
      'username':'Emie.Lockman',
      'email':'Lowell.Rice33@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Emie.Lockman' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'vJsfOzt39tu2UOs',
      'isDeleted':false,
      'username':'Meda.Langosh46',
      'email':'Leopold.Ullrich@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Meda.Langosh46' }, userToBeInserted,  { upsert: true });
